...
<div class="content-wrapper" >
  ...
  <form action="medical_ad.php" method="POST">
  <div class="reg">
                          <label for="name">Reg_id</label>
                          <input type="text" id="name" name="reg_id" value="<?php echo $_REQUEST['reg_id'];?>">
                      </div>
      <article>
                  ...
                  <div class="form_wrap">
                              ...
                              <tr>
                                  ...
                                  <td>
                                      <div class="input_wra">
                                          ...
                                          <input type="text" id="name" name="Murmurs" value="<?php echo $Murmurs;?>">
                                      </div>
                                  </td>
                                  <td>
                                      <div class="input_wra">
                      ...
                      <div class="input_wrap">
                          <table class="t1">
                              ...
                              <tr>
                                  <td>
                                      <textarea name="Cardiovascular_Other" rows="2" ><?php echo $Cardiovascular_Other;?></textarea>
                                  </td>
                              </tr>
                          </table>
                      </div>
                      ...
                      <div class="input_wra">
                          <label class="check_wrap">
                              <table class="t2" >
                                  <tr>
                                      <td><input type="checkbox" name="Cardiovascular_status_controled" value="Controled"> <span>Controled</span></td>
                                      <td width="50%"></td>
                                      <td><input type="checkbox" name="Cardiovascular_status_danger" value="Danger"> <span>Danger</span></td>
                                  </tr>
                              </table>
                          </label>
                      </div>
                      ...
                      <div class="input_wrap">
                          ...
                          <table class="t1">
                              ...
                              <tr>
                                  <td>
                                      <textarea name="symptoms_respiratory" rows="2"><?php echo $symptoms_respiratory;?></textarea>
                                  </td>
                              </tr>
                          </table>
                      </div>
                      ...
                      <div class="input_wrap">
                          <table class="t1">
                              ...
                              <tr>
                                  <td>
                                      <textarea name="Respiratory_other" rows="2"><?php echo $Respiratory_other;?></textarea>
                                  </td>
                              </tr>
                          </table>
                      </div>
                      <div class="input_wra">
                          <label class="check_wrap">
                              <table class="t2">
                                  <tr>
                                      <td><input type="checkbox" name="Respiratory_status_controled" value="Controled"> <span>Controled</span></td>
                                      <td width="50%"></td>
                                      <td><input type="checkbox" name="Respiratory_status_controled" value="Danger"> <span>Danger</span></td>
                                  </tr>
                              </table>
                          </label>
                      </div>
                              ...
                              <tr>
                                  <td>
                                      <div class="input_wra">
                                          ...
                                          <input type="text" id="name" name="Chronic_Kidney_Disease" value="<?php echo $Chronic_Kidney_Disease;?>">
                                      </div>
                                  </td>
                                  <td>
                                      <div class="input_wra">
                                          <label for="name">Stones</label>
                                          <input type="text" id="name" name="Stones" value="<?php echo $Stones;?>">
                                      </div>
                                  </td>
                      ...
                      <div class="input_wra">
                          <label class="check_wrap">
                              <table class="t2">
                                  <tr>
                                      <td><input type="checkbox" name="Renal_status_controled" value="Controled"> <span>Controled</span></td>
                                      <td width="50%"></td>
                                      <td><input type="checkbox" name="Renal_status_danger" value="Danger"> <span>Danger</span></td>
                                  </tr>
                              </table>
                          </label>
                      </div>
                      ...
                      <div class="input_wra">
                          <label class="check_wrap">
                              <table class="t2">
                                  <tr>
                                      <td><input type="checkbox" name="GORD_status_controled" value="Controled"> <span>Controled</span></td>
                                      <td width="50%"></td>
                                      <td><input type="checkbox" name="GORD_status_danger" value="Danger"> <span>Danger</span></td>
                                  </tr>
                              </table>
                          </label>
                      </div>
                              ...
                              <tr>
                                  <td>
                                      <div class="input_wra">
                                          ...
                                          <input type="text" id="name" name="Anaemia" value="<?php echo $Anaemia;?>">
                                      </div>
                                  </td>
                                  <td>
                                      <div class="input_wra">
                                          <label for="name">Diabetes</label>
                                          <input type="text" id="name" name="Diabetes" value="<?php echo $Diabetes;?>">
                                      </div>
                                  </td>
                      ...
                      <div class="input_wra">
                          <label class="check_wrap">
                              <table class="t2">
                                  <tr>
                                      <td><input type="checkbox" name="Haem_status_controled" value="Controled"> <span>Controled</span></td>
                                      <td width="50%"></td>
                                      <td><input type="checkbox" name="Haem_status_danger" value="Danger"> <span>Danger</span></td>
                                  </tr>
                              </table>
                          </label>
                      </div>
                              ...
                              <tr>
                                  <td>
                                      <div class="input_wra">
                                          ...
                                          <input type="text" id="name" name="Strikes" value="<?php echo $Strikes;?>">
                                      </div>
                                  </td>
                                  <td>
                                      <div class="input_wra">
                                  ...
                                  <td>
                                      <div class="input_wra">
                                          ...
                                          <input type="text" id="name" name="Osteoartheritis" value="<?php echo $Osteoartheritis;?>">
                                      </div>
                                  </td>
                                  <td>
                                      <div class="input_wra">
                                          <label for="name">Osteoporosis</label>
                                          <input type="text" id="name" name="Osteoporosis" value="<?php echo $Osteoporosis;?>">
                                      </div>
                                  </td>
                              </tr>
                      ...
                      <div class="input_wra">
                          <label class="check_wrap">
                              <table class="t2">
                                  <tr>
                                      <td><input type="checkbox" name="Neuro_status_controled" value="Controled"> <span>Controled</span></td>
                                      <td width="50%"></td>
                                      <td><input type="checkbox" name="Neuro_status_danger" value="Danger"> <span>Danger</span></td>
                                  </tr>
                              </table>
                          </label>
                      </div>
                      ...
                      <div class="input_wra">
                          <label class="check_wrap">
                              <table class="t2">
                                  <tr>
                                      <td><input type="checkbox" name="POA_status_controled" value="Controled"> <span>Controled</span></td>
                                      <td width="50%"></td>
                                      <td><input type="checkbox" name="POA_status_danger" value="Danger"> <span>Danger</span></td>
                                  </tr>
                              </table>
                          </label>
                      </div>
                  ...
                  <div class="form_wrap">
                      ...
                      <div class="input_wrap">
                          ...
                          <table class="t2">
                              <tr>
                                  <div class="input_wra">
                                      <label class="check_wrap">
                                          <td><input type="checkbox" name="Allergies_types" value="food"> <span>Food</span></td>
                                          <td><input type="checkbox" name="Allergies_types" value="drugs"> <span>Drugs</span></td>
                                          <td><input type="checkbox" name="Allergies_types" value="plasters"> <span>Plasters</span></td>
                                      </label>
                                  </div>
                          ...
                          <table class="t1">
                              ...
                              <tr>
                                  <td>
                                      <textarea name="Allergies_other" rows="2"><?php echo $Allergies_other;?></textarea>
                                  </td>
                              </tr>
                          </table>
                      </div>
                      ...
                      <div class="input_wra">
                          <label class="check_wrap">
                              <table class="t2">
                                  <tr>
                                      <td><input type="checkbox" name="MET_status_controled" value="Controled"> <span>Controled</span></td>
                                      <td width="50%"></td>
                                      <td><input type="checkbox" name="MET_status_danger" value="Danger"> <span>Danger</span></td>
                                  </tr>
                              </table>
                          </label>
                      </div>
                                  ...
                                  <div class="input_grp">
                                      <td>
                                          ...
                                          <div class="input_wra">
                                              ...
                                              <input type="radio" name="smoking_yn" value="yes" class="input_radio">
                                              <span>Yes</span>
                                          </div>
                                      </td>
                                      <td>
                                          <div class="input_wra">
                                              <input type="radio" name="smoking_yn" value="no" class="input_radio">
                                              <span>No</span>
                      ...
                      <div class="input_wrap">
                          <table class="t1">
                              ...
                              <tr>
                                  <td>
                                      <textarea name="smoking_other" rows="2"><?php echo $smoking_other?></textarea>
                                  </td>
                              </tr>
                          </table>
                      </div>
                      <div class="input_wra">
                          <label class="check_wrap">
                              <table class="t2">
                                  <tr>
                                      <td><input type="checkbox" name="Smoking_status_controled" value="Controled"> <span>Controled</span></td>
                                      <td width="50%"></td>
                                      <td><input type="checkbox" name="Smoking_status_danger" value="Danger"> <span>Danger</span></td>
                                  </tr>
                              </table>
                          </label>
                      </div>
                      ...
                      <div class="input_wrap">
                          <table class="t1">
                              ...
                              <tr>
                                  <td>
                                      <textarea name="alcohol_other" rows="2"><?php echo $alcohol_other;?></textarea>
                                  </td>
                              </tr>
                          </table>
                      </div>
                      <div class="input_wra">
                          <label class="check_wrap">
                              <table class="t2" >
                                  <tr>
                                      <td><input type="checkbox" name="Alcohol_status_controled" value="Controled" > <span >Controled</span></td>
                                      <td width="50%"></td>
                                      <td><input type="checkbox" name="Alcohol_status_danger" value="Danger"> <span>Danger</span></td>
                                  </tr>
                              </table>
                          </label>
                      </div>
                      ...
                      <div class="input_wrap">
                          <div class="input_wrap">
                              ...
                              <textarea name="Current_Medication" cols="50" rows="2"><?php echo $Current_Medication;?></textarea>
                          </div>
                          <div class="input_wrap">
                              <table class="t1">
                                  <tr>
                                  ...
                                  <tr>
                                      <td>
                                          <textarea name="Current_Medication_other" rows="2"><?php echo $Current_Medication_other;?></textarea>
                                      </td>
                                  </tr>
                              </table>
                          </div>
                          ...
                          <table class="t2">
                              <tr>
                                  <div class="input_wra">
                                      <label class="check_wrap">
                                          <td><input type="checkbox" name="Previous_anesthesia_types" value="GA"> <span>GA</span></td>
                                          <td><input type="checkbox"name="Previous_anesthesia_types" value="Spinal"> <span>Spinal</span></td>
                                          <td><input type="checkbox" name="Previous_anesthesia_types" value="Epidural"> <span>Epidural</span></td>
                                      </label>
                                  </div>
                          ...
                          <div class="input_wrap">
                              <table class="t1">
                                  ...
                                  <tr>
                                      <td>
                                          <textarea name="Operations" cols="50" rows="2"><?php echo $Operations;?></textarea>
                                      </td>
                                  </tr>
                              </table>
                          </div>
                          <div class="input_wrap">
                              ...
                              <div class="input_wra">
                                  ...
                                  <table class="t2">
                                      <tr>
                                          <td><input type="checkbox" name="Operations_types" value=">Difficult Airway"> <span>Difficult Airway</span></td>
                                      </tr>
                                      <tr>
                                          <td><input type="checkbox" name="Operations_types" value="Dclayed recovery"> <span>Dclayed recovery</span></td>
                                      </tr>
                                      <tr>
                                          <td><input type="checkbox" name="Operations_types" value="Anaphylactic reactions"> <span>Anaphylactic reactions</span></td>
                                      </tr>
                                      <tr>
                                          <td><input type="checkbox" name="Operations_types" value="F/H Anesthesia Problems"> <span>F/H Anesthesia Problems</span>
                                          </td>
                                      </tr>
                                  </table>
                          ...
                          <div class="input_wrap">
                              <table class="t1">
                                  ...
                                  <tr>
                                      <td>
                                          <textarea name="Operations_other" rows="2"><?php echo $Operations_other;?></textarea>
                                      </td>
                                  </tr>
                              </table>
                          </div>
                      ...
                      <div class="input_wrap">
                          ...
                          <div class="input_wra">
                              ...
                              <table class="t2">
                                  <tr>
                                      <td><input type="checkbox" name="Airway_Assessment_types" value="Teeth/ Denture"> <span>Teeth/ Denture</span></td>
                                  </tr>
                                  <tr>
                                      <td><input type="checkbox" name="Airway_Assessment_types" value="Mouth Opening: full/partial/ none"> <span>Mouth Opening: full/partial/ none</span></td>
                                  </tr>
                                  <tr>
                                      <td><input type="checkbox" name="Airway_Assessment_types" value="Neck movements: full/ limited"> <span>Neck movements: full/ limited</span></td>
                                  </tr>
                                  <tr>
                                      <td><input type="checkbox" name="Airway_Assessment_types" value="Mallampati score 1/2/3/4"> <span>Mallampati score 1/2/3/4</span>
                                      </td>
                                  </tr>
                              </table>
                                      ...
                                      <td>
                                          <div class="input_wra">
                                              <select name="Fasting">
                                                  ...
                                                  <option value="4 hrs fpr breakfast milk">4 hrs fpr breakfast milk</option>
                                                  <option value="2 hrs for clear fluids">2 hrs for clear fluids</option>
                                              </select>
                          ...
                          <div class="input_wrap">
                              <table class="t1">
                                  ...
                                  <tr>
                                      <td>
                                          <textarea name="Investigations" cols="50" rows="1"><?php echo $Investigations;?></textarea>
                                      </td>
                                  </tr>
                              </table>
                          </div>
                          <div class="input_wrap">
                              <table class="t1">
                                  ...
                                  <tr>
                                      <td>
                                          <textarea name="Premedication" cols="50" rows="1"><?php echo $Premedication;?></textarea>
                                      </td>
                                  </tr>
                              </table>
                          </div>
                          <div class="input_wrap">
                              <table class="t1">
                                  ...
                                  <tr>
                                      <td>
                                          <textarea name="Drugs_to_be_omitted" cols="50" rows="1"><?php echo $Drugs_to_be_omitted;?></textarea>
                                      </td>
                                  </tr>
                              </table>
                          </div>
                          <div class="input_wrap">
                              <table class="t1">
                                  ...
                                  <tr>
                                      <td>
                                          <textarea name="DVT_Prophyluxis" cols="50" rows="1"><?php echo $DVT_Prophyluxis;?></textarea>
                                      </td>
                                  </tr>
                              </table>
                          </div>
                          <div class="input_wrap">
                              <table class="t1">
                                  ...
                                  <tr>
                                      <td>
                                          <textarea name="Preoperative_instructions_other" cols="50" rows="1"><?php echo $Preoperative_instructions_other;?></textarea>
                                      </td>
                                  </tr>
                              </table>
                          </div>
                  ...
                  <div class="form_wrap">
                              ...
                              <tr>
                                  <td>
                                      <div class="input_wra">
                                          ...
                                          <input type="text" id="name" name="FBS_RBS_PPBS" value = "<?php echo $FBS_RBS_PPBS;?>">
                                      </div>
                                  </td>
                      ...
                      <div class="input_wra">
                          <label class="check_wrap">
                              <table class="t2">
                                  <tr>
                                      <td><input type="checkbox" name="Investigation_status_controled" value="Controled"> <span>Controled</span></td>
                                      <td width="50%"></td>
                                      <td><input type="checkbox" name="Investigation_status_danger" value="Danger"> <span>Danger</span></td>
                                  </tr>
                              </table>
                          </label>
                      </div>
                      ...
                      <div class="input_wrap">
                          ...
                          <div class="input_wra">
                              ...
                              <table class="t2">
                                  <tr>
                                      <td><input type="checkbox" name="Anticipated_Anesthetic_problem_types" value="Difficult Airway"> <span>Difficult Airway</span></td>
                                  </tr>
                                  <tr>
                                      <td><input type="checkbox" name="Anticipated_Anesthetic_problem_types" value="Aspiration"> <span>Aspiration</span></td>
                                  </tr>
                                  <tr>
                                      <td><input type="checkbox" name="Anticipated_Anesthetic_problem_types" value="RS instability"> <span>RS instability</span></td>
                                  </tr>
                                  <tr>
                                      <td><input type="checkbox" name="Anticipated_Anesthetic_problem_types" value="Massive fluid shifts"> <span>Massive fluid shifts</span>
                                      </td>
                                  </tr>
                                  <tr>
                                      <td><input type="checkbox" name="Anticipated_Anesthetic_problem_types" value="Massive Blood Transfution"> <span>Massive Blood Transfution</span>
                                      </td>
                                  </tr>
                              </table>
                      ...
                      <div class="input_wrap">
                          <table class="t1">
                              ...
                              <td>
                                  <textarea name="Anticipated Anesthetic problem_other" cols="50" rows="4"></textarea>
                              </td>
                              </tr>
                          </table>
                      </div>
                      ...
                      <div class="input_wrap">
                          ...
                          <div class="input_wra">
                              ...
                              <table class="t2">
                                  <tr>
                                      <td><input type="checkbox" name="Anesthetic_Plan" value="GA"> <span>GA</span></td>
                                  </tr>
                                  <tr>
                                      <td><input type="checkbox" name="Anesthetic_Plan" value="Spinal"> <span>Spinal</span></td>
                                  </tr>
                                  <tr>
                                      <td><input type="checkbox" name="Anesthetic_Plan" value="Epidural"> <span>Epidural</span></td>
                                  </tr>
                                  <tr>
                                      <td><input type="checkbox" name="Anesthetic_Plan" value="Pre oxygenation"> <span>Pre oxygenation</span>
                                      </td>
                                  </tr>
                                  <tr>
                                      <td><input type="checkbox" name="Anesthetic_Plan" value="RSI"> <span>RSI</span>
                                      </td>
                                  </tr>
                                  <tr>
                                      <td><input type="checkbox" name="Anesthetic_Plan" value="Throat Pack"> <span>Throat pack</span></td>
                                  </tr>
                                  <tr>
                                      <td><input type="checkbox" name="Anesthetic_Plan" value="Nerve Blocks"> <span>Nerve Blocks</span></td>
                                  </tr>
                                  <tr>
                                      <td>
                                          <div class="input_wra">
  ...
  <input type="text" name="asalevel" value = "<?php echo $asa;?>" style="margin:auto; padding:auto; display:block"></center>
  </div>
